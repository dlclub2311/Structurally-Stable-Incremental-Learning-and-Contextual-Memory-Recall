...
def gradcam_hook_functn(self, gradinput, gradoutput): 
        self.gradcam_gradients = gradoutput[0].detach()
...
class ResNet(nn.Module):
    ...
    def activate_gradcam_hooks(self): 
        ...
        self.gradcam_hook = self.stage_4_importance.register_backward_hook(gradcam_hook_functn)
