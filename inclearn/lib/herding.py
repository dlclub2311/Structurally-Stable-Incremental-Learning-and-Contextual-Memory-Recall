...
def icarl_selection(features, nb_examplars):
    #print(f"features.shape,nb_exam in icarl_selection {features.shape} {nb_examplars}")
    D = features.T
    ...
    #print(f"selected indices in icarl_selection {herding_matrix.argsort()[:nb_examplars]}")
